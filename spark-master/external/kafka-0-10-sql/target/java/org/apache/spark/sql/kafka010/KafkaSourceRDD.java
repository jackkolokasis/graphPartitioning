 ...
 */
  ...
  public   KafkaSourceRDD (org.apache.spark.SparkContext sc, java.util.Map<java.lang.String, java.lang.Object> executorKafkaParams, scala.collection.Seq<org.apache.spark.sql.kafka010.KafkaSourceRDDOffsetRange> offsetRanges, long pollTimeoutMs, boolean failOnDataLoss, boolean reuseKafkaConsumer)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.kafka010.KafkaSourceRDDOffsetRange resolveRange (org.apache.spark.sql.kafka010.CachedKafkaConsumer consumer, org.apache.spark.sql.kafka010.KafkaSourceRDDOffsetRange range)  { throw new RuntimeException(); }
}

 ...
 */
  ...
  public  void printClass ()  { throw new RuntimeException(); }
  ...
  public  long srcIds (int pos)  { throw new RuntimeException(); }
  public  long dstIds (int pos)  { throw new RuntimeException(); }
  private  ED attrs (int pos)  { throw new RuntimeException(); }
  public  int[] getSrcIds ()  { throw new RuntimeException(); }
  public  int[] getDstIds ()  { throw new RuntimeException(); }
  ...
  public  void printEdgesInPartition (int pid)  { throw new RuntimeException(); }
  /**

...
public abstract class Graph<VD extends java.lang.Object, ED extends java.lang.Object> implements scala.Serializable {
  ...
  /**
   * Repartitions the edges in the graph according to <code>partitionStrategy including Hybrid</code>.
   * <p>
   * @param partitionStrategy the partitioning strategy to use when partitioning the edges
   * in the graph.
   * @param numPartitions the number of edge partitions in the new graph.
   * @param threshold threshold for hybrid partitioning
   * @param ThreshHold (undocumented)
   * @return (undocumented)
   */
  public abstract  org.apache.spark.graphx.Graph<VD, ED> partitionBy (org.apache.spark.graphx.PartitionStrategy partitionStrategy, int numPartitions, int ThreshHold)  ;
  /**

...
public  interface PartitionStrategy extends scala.Serializable {
  ...
  static public  class SrcCutPartition$ implements org.apache.spark.graphx.PartitionStrategy, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final SrcCutPartition$ MODULE$ = null;
    public   SrcCutPartition$ ()  { throw new RuntimeException(); }
    public  int getPartition (long src, long dst, int numParts)  { throw new RuntimeException(); }
  }
  static public  class DstCutPartition$ implements org.apache.spark.graphx.PartitionStrategy, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final DstCutPartition$ MODULE$ = null;
    public   DstCutPartition$ ()  { throw new RuntimeException(); }
    public  int getPartition (long src, long dst, int numParts)  { throw new RuntimeException(); }
  }
  /**
   ...
   */
  static public  class GreedyHybridCut$ implements org.apache.spark.graphx.PartitionStrategy, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final GreedyHybridCut$ MODULE$ = null;
    public   GreedyHybridCut$ ()  { throw new RuntimeException(); }
    public  int getPartition (long src, long dst, int numParts)  { throw new RuntimeException(); }
  }
  static public  class HybridCutPlus$ implements org.apache.spark.graphx.PartitionStrategy, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final HybridCutPlus$ MODULE$ = null;
    public   HybridCutPlus$ ()  { throw new RuntimeException(); }
    public  int getPartition (long src, long dst, int numParts)  { throw new RuntimeException(); }
  }
  static public  class HybridCut$ implements org.apache.spark.graphx.PartitionStrategy, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
    public static final HybridCut$ MODULE$ = null;
    public   HybridCut$ ()  { throw new RuntimeException(); }
    public  int getPartition (long src, long dst, int numParts)  { throw new RuntimeException(); }
  }

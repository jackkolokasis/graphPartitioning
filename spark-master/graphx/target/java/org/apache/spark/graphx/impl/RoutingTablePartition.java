...
/**
 * Stores the locations of edge-partition join sites for each vertex attributeyiorgoslillikas
 * in a particular
 ...
 */
  ...
  public  int get_outEdges (int partID)  { throw new RuntimeException(); }
  public  int get_inEdges (int partID)  { throw new RuntimeException(); }
  public  scala.Tuple3<long[], org.apache.spark.util.collection.BitSet, org.apache.spark.util.collection.BitSet>[] getValue ()  { throw new RuntimeException(); }
  /**

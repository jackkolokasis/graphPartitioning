 ...
 */
  ...
  static public  org.apache.spark.storage.BlockId[] blockIds ()  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Map<org.apache.spark.storage.BlockId, scala.collection.Seq<java.lang.String>> _locations ()  { throw new RuntimeException(); }
  static   void removeBlocks ()  { throw new RuntimeException(); }
  static   void assertValid ()  { throw new RuntimeException(); }
  static protected  scala.collection.immutable.Map<org.apache.spark.storage.BlockId, scala.collection.Seq<java.lang.String>> getBlockIdLocations ()  { throw new RuntimeException(); }
  private  org.apache.spark.storage.BlockId[] _blockIds ()  { throw new RuntimeException(); }
  public  org.apache.spark.streaming.util.WriteAheadLogRecordHandle[] walRecordHandles ()  { throw new RuntimeException(); }
  private  boolean[] isBlockIdValid ()  { throw new RuntimeException(); }
  // not preceding
  ...
  private  org.apache.spark.util.SerializableConfiguration broadcastedHadoopConf ()  { throw new RuntimeException(); }

...
public  class ShowCreateTableCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  private  java.lang.String showCreateHiveTable (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata)  { throw new RuntimeException(); }
  private  void showHiveTableHeader (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  java.lang.String columnToDDLFragment (org.apache.spark.sql.types.StructField column)  { throw new RuntimeException(); }
  private  void showHiveTableNonDataColumns (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  void showHiveTableStorageInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  void showHiveTableProperties (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  java.lang.String showCreateDataSourceTable (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata)  { throw new RuntimeException(); }
  private  void showDataSourceTableDataColumns (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  void showDataSourceTableOptions (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  void showDataSourceTableNonDataColumns (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.StringBuilder builder)  { throw new RuntimeException(); }
  private  java.lang.String escapeSingleQuotedString (java.lang.String str)  { throw new RuntimeException(); }
}

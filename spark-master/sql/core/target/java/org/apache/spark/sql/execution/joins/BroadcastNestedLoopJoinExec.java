...
public  class BroadcastNestedLoopJoinExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.BinaryExecNode, scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.catalyst.expressions.UnsafeProjection genResultProjection ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> innerJoin (org.apache.spark.broadcast.Broadcast<org.apache.spark.sql.catalyst.InternalRow[]> relation)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> outerJoin (org.apache.spark.broadcast.Broadcast<org.apache.spark.sql.catalyst.InternalRow[]> relation)  { throw new RuntimeException(); }
  /**
   * The implementation for these joins:
   * <p>
   ...
   * @param relation (undocumented)
   * @param exists (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> leftExistenceJoin (org.apache.spark.broadcast.Broadcast<org.apache.spark.sql.catalyst.InternalRow[]> relation, boolean exists)  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> existenceJoin (org.apache.spark.broadcast.Broadcast<org.apache.spark.sql.catalyst.InternalRow[]> relation)  { throw new RuntimeException(); }
  /**
   * The implementation for these joins:
   * <p>
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> defaultJoin (org.apache.spark.broadcast.Broadcast<org.apache.spark.sql.catalyst.InternalRow[]> relation)  { throw new RuntimeException(); }

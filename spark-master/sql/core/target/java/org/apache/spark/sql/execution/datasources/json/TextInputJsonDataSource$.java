...
public  class TextInputJsonDataSource$ extends org.apache.spark.sql.execution.datasources.json.JsonDataSource {
  ...
  private  org.apache.spark.sql.Dataset<java.lang.String> createBaseDataset (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> inputPaths)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.unsafe.types.UTF8String textToUTF8String (org.apache.hadoop.io.Text value)  { throw new RuntimeException(); }
}

...
public  class SortBasedAggregator {
  ...
  private  org.apache.spark.sql.execution.UnsafeKVExternalSorter inputSorter ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.catalyst.expressions.codegen.BaseOrdering groupingKeyOrdering ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.execution.UnsafeKVExternalSorter createExternalSorterForInput ()  { throw new RuntimeException(); }
}

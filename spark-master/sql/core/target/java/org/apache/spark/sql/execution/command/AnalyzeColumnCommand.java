 ...
 * query optimizations.
 */
public  class AnalyzeColumnCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
   ...
   */
  private  scala.Tuple2<java.lang.Object, scala.collection.immutable.Map<java.lang.String, org.apache.spark.sql.catalyst.plans.logical.ColumnStat>> computeColumnStats (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.TableIdentifier tableIdent, scala.collection.Seq<java.lang.String> columnNames)  { throw new RuntimeException(); }
}

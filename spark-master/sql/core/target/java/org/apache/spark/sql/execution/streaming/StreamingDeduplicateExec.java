...
public  class StreamingDeduplicateExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.streaming.StateStoreWriter, org.apache.spark.sql.execution.streaming.WatermarkSupport, scala.Product, scala.Serializable {
  static private  org.apache.spark.sql.catalyst.expressions.UnsafeRow EMPTY_ROW ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   StreamingDeduplicateExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> keyExpressions, org.apache.spark.sql.execution.SparkPlan child, scala.Option<org.apache.spark.sql.execution.streaming.OperatorStateId> stateId, scala.Option<java.lang.Object> eventTimeWatermark)  { throw new RuntimeException(); }

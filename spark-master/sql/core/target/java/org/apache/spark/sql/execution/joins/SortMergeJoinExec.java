 ...
 */
public  class SortMergeJoinExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.BinaryExecNode, org.apache.spark.sql.execution.CodegenSupport, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SortMergeJoinExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> leftKeys, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> rightKeys, org.apache.spark.sql.catalyst.plans.JoinType joinType, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> condition, org.apache.spark.sql.execution.SparkPlan left, org.apache.spark.sql.execution.SparkPlan right)  { throw new RuntimeException(); }
   ...
   * @param childOutputOrdering (undocumented)
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.SortOrder> getKeyOrdering (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> keys, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.SortOrder> childOutputOrdering)  { throw new RuntimeException(); }
  ...
  private  int getSpillThreshold ()  { throw new RuntimeException(); }
  ...
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> createJoinKey (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, java.lang.String row, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> keys, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> input)  { throw new RuntimeException(); }
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> copyKeys (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> vars)  { throw new RuntimeException(); }
  private  java.lang.String genComparision (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> a, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> b)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.Tuple2<java.lang.String, java.lang.String> genScanner (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  /**
   ...
   * @param ctx (undocumented)
   * @param leftRow (undocumented)
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> createLeftVars (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, java.lang.String leftRow)  { throw new RuntimeException(); }
  /**
   * Creates the variables for right part of result row, using BoundReference, since the right
   * part are accessed inside the loop.
   * @param ctx (undocumented)
   * @param rightRow (undocumented)
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> createRightVar (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, java.lang.String rightRow)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.Tuple2<java.lang.String, java.lang.String> splitVarsByCondition (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attributes, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> variables)  { throw new RuntimeException(); }

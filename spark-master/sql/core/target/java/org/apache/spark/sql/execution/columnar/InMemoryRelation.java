...
public  class InMemoryRelation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.execution.columnar.InMemoryRelation apply (boolean useCompression, int batchSize, org.apache.spark.storage.StorageLevel storageLevel, org.apache.spark.sql.execution.SparkPlan child, scala.Option<java.lang.String> tableName)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.rdd.RDD<org.apache.spark.sql.execution.columnar.CachedBatch> _cachedColumnBuffers ()  { throw new RuntimeException(); }
  public  org.apache.spark.util.LongAccumulator batchStats ()  { throw new RuntimeException(); }
  public   InMemoryRelation (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, boolean useCompression, int batchSize, org.apache.spark.storage.StorageLevel storageLevel, org.apache.spark.sql.execution.SparkPlan child, scala.Option<java.lang.String> tableName, org.apache.spark.rdd.RDD<org.apache.spark.sql.execution.columnar.CachedBatch> _cachedColumnBuffers, org.apache.spark.util.LongAccumulator batchStats)  { throw new RuntimeException(); }
  protected  scala.collection.Seq<org.apache.spark.sql.execution.SparkPlan> innerChildren ()  { throw new RuntimeException(); }

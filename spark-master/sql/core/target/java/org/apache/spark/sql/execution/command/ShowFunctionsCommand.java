 ...
 */
public  class ShowFunctionsCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ShowFunctionsCommand (scala.Option<java.lang.String> db, scala.Option<java.lang.String> pattern, boolean showUserFunctions, boolean showSystemFunctions)  { throw new RuntimeException(); }

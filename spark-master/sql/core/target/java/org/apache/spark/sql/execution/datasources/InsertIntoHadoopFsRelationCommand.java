 ...
 */
public  class InsertIntoHadoopFsRelationCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   InsertIntoHadoopFsRelationCommand (org.apache.hadoop.fs.Path outputPath, scala.collection.immutable.Map<java.lang.String, java.lang.String> staticPartitions, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> partitionColumns, scala.Option<org.apache.spark.sql.catalyst.catalog.BucketSpec> bucketSpec, org.apache.spark.sql.execution.datasources.FileFormat fileFormat, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, org.apache.spark.sql.SaveMode mode, scala.Option<org.apache.spark.sql.catalyst.catalog.CatalogTable> catalogTable, scala.Option<org.apache.spark.sql.execution.datasources.FileIndex> fileIndex)  { throw new RuntimeException(); }
   ...
   * @param qualifiedOutputPath (undocumented)
   * @param customPartitionLocations (undocumented)
   * @param committer (undocumented)
   */
  private  void deleteMatchingPartitions (org.apache.hadoop.fs.FileSystem fs, org.apache.hadoop.fs.Path qualifiedOutputPath, scala.collection.immutable.Map<scala.collection.immutable.Map<java.lang.String, java.lang.String>, java.lang.String> customPartitionLocations, org.apache.spark.internal.io.FileCommitProtocol committer)  { throw new RuntimeException(); }
  /**
   ...
   */
  private  scala.collection.immutable.Map<scala.collection.immutable.Map<java.lang.String, java.lang.String>, java.lang.String> getCustomPartitionLocations (org.apache.hadoop.fs.FileSystem fs, org.apache.spark.sql.catalyst.catalog.CatalogTable table, org.apache.hadoop.fs.Path qualifiedOutputPath, scala.collection.Seq<org.apache.spark.sql.catalyst.catalog.CatalogTablePartition> partitions)  { throw new RuntimeException(); }
}

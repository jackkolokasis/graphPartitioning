...
public  class TextInputCSVDataSource$ extends org.apache.spark.sql.execution.datasources.csv.CSVDataSource {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.StructType inferFromDataset (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.Dataset<java.lang.String> csv, scala.Option<java.lang.String> maybeFirstLine, org.apache.spark.sql.execution.datasources.csv.CSVOptions parsedOptions)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.Dataset<java.lang.String> createBaseDataset (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> inputPaths, org.apache.spark.sql.execution.datasources.csv.CSVOptions options)  { throw new RuntimeException(); }
}

...
public  class TextInputJsonDataSource {
  ...
  static private  org.apache.spark.sql.Dataset<java.lang.String> createBaseDataset (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> inputPaths)  { throw new RuntimeException(); }
  ...
  static private  org.apache.spark.unsafe.types.UTF8String textToUTF8String (org.apache.hadoop.io.Text value)  { throw new RuntimeException(); }

...
public  class CSVUtils {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.Dataset<java.lang.String> filterCommentAndEmpty (org.apache.spark.sql.Dataset<java.lang.String> lines, org.apache.spark.sql.execution.datasources.csv.CSVOptions options)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Iterator<java.lang.String> filterCommentAndEmpty (scala.collection.Iterator<java.lang.String> iter, org.apache.spark.sql.execution.datasources.csv.CSVOptions options)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Iterator<java.lang.String> filterHeaderLine (scala.collection.Iterator<java.lang.String> iter, java.lang.String firstLine, org.apache.spark.sql.execution.datasources.csv.CSVOptions options)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.Iterator<java.lang.String> dropHeaderLine (scala.collection.Iterator<java.lang.String> iter, org.apache.spark.sql.execution.datasources.csv.CSVOptions options)  { throw new RuntimeException(); }
  /**

...
public  class Dataset<T extends java.lang.Object> implements scala.Serializable {
   ...
   *  - When <code>U</code> is a tuple, the columns will be mapped by ordinal (i.e. the first column will
   ...
   *    <code>mapGroupsWithState</code> and <code>dropDuplicates</code> operators.
   * <p>
   ...
   *                 <code>inner</code>, <code>cross</code>, <code>outer</code>, <code>full</code>, <code>full_outer</code>, <code>left</code>, <code>left_outer</code>,
   *                 <code>right</code>, <code>right_outer</code>, <code>left_semi</code>, <code>left_anti</code>.
   * <p>
   * @note If you perform a self-join using this function without aliasing the input
   * <code>DataFrame</code>s, you will NOT be able to reference any columns after the join, since
   * there is no way to disambiguate which side of the join you would like to reference.
  ...
  */
  ...
  /**
   * Represents the content of the Dataset as an <code>RDD</code> of <code>T</code>.
   * <p>
   * @group basic
   * @since 1.6.0
   * @return (undocumented)
  ...
  */
   ...
   * @param qe (undocumented)
   * @param action (undocumented)
   * @return (undocumented)
   */
  private <U extends java.lang.Object> U withAction (java.lang.String name, org.apache.spark.sql.execution.QueryExecution qe, scala.Function1<org.apache.spark.sql.execution.SparkPlan, U> action)  { throw new RuntimeException(); }
  /**
   * Collect all elements from a spark plan.
   * @param plan (undocumented)
   * @return (undocumented)
   */
  private  java.lang.Object collectFromPlan (org.apache.spark.sql.execution.SparkPlan plan)  { throw new RuntimeException(); }

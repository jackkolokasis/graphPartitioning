 ...
 */
public  class HashAggregateExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.CodegenSupport, scala.Product, scala.Serializable {
  ...
  private  scala.Option<scala.Tuple2<java.lang.Object, java.lang.Object>> testFallbackStartsAt ()  { throw new RuntimeException(); }
  protected  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> doExecute ()  { throw new RuntimeException(); }
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.aggregate.AggregateMode> modes ()  { throw new RuntimeException(); }
  ...
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> bufVars ()  { throw new RuntimeException(); }
  private  java.lang.String doProduceWithoutKeys (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  protected  boolean shouldStopRequired ()  { throw new RuntimeException(); }
  private  java.lang.String doConsumeWithoutKeys (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> input)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.types.StructType groupingKeySchema ()  { throw new RuntimeException(); }
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.aggregate.DeclarativeAggregate> declFunctions ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.types.StructType bufferSchema ()  { throw new RuntimeException(); }
  private  java.lang.String fastHashMapTerm ()  { throw new RuntimeException(); }
  private  boolean isFastHashMapEnabled ()  { throw new RuntimeException(); }
  private  boolean isVectorizedHashMapEnabled ()  { throw new RuntimeException(); }
  private  java.lang.String hashMapTerm ()  { throw new RuntimeException(); }
  private  java.lang.String sorterTerm ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.unsafe.KVIterator<org.apache.spark.sql.catalyst.expressions.UnsafeRow, org.apache.spark.sql.catalyst.expressions.UnsafeRow> finishAggregate (org.apache.spark.sql.execution.UnsafeFixedWidthAggregationMap hashMap, org.apache.spark.sql.execution.UnsafeKVExternalSorter sorter, org.apache.spark.sql.execution.metric.SQLMetric peakMemory, org.apache.spark.sql.execution.metric.SQLMetric spillSize)  { throw new RuntimeException(); }
  /**
   * Generate the code for output.
   * @param ctx (undocumented)
   * @param keyTerm (undocumented)
   * @param bufferTerm (undocumented)
   * @param plan (undocumented)
   * @return (undocumented)
   */
  private  java.lang.String generateResultCode (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, java.lang.String keyTerm, java.lang.String bufferTerm, java.lang.String plan)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  boolean checkIfFastHashMapSupported (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  private  Object enableTwoLevelHashMap (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  private  java.lang.String doProduceWithKeys (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  private  java.lang.String doConsumeWithKeys (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.codegen.ExprCode> input)  { throw new RuntimeException(); }
  public  java.lang.String verboseString ()  { throw new RuntimeException(); }
  public  java.lang.String simpleString ()  { throw new RuntimeException(); }
  private  java.lang.String toString (boolean verbose)  { throw new RuntimeException(); }
}

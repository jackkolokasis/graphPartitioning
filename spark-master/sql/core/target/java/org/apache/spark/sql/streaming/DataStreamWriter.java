...
public final class DataStreamWriter<T extends java.lang.Object> {
   ...
   *                 contain aggregations, it will be equivalent to <code>append</code> mode.
   * @since 2.0.0
   * @param outputMode (undocumented)
   * @return (undocumented)
   */
   ...
   * <code>ForeachWriter</code> as new data arrives. The <code>ForeachWriter</code> can be used to send the data

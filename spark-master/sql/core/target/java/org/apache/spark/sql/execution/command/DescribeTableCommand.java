 ...
 * </code></pre>
 */
public  class DescribeTableCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  public  boolean isFormatted ()  { throw new RuntimeException(); }
  // not preceding
  public   DescribeTableCommand (org.apache.spark.sql.catalyst.TableIdentifier table, scala.collection.immutable.Map<java.lang.String, java.lang.String> partitionSpec, boolean isExtended, boolean isFormatted)  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.Row> run (org.apache.spark.sql.SparkSession sparkSession)  { throw new RuntimeException(); }
  private  void describePartitionInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable table, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeExtendedTableInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable table, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeFormattedTableInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable table, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeStorageInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeViewInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeBucketingInfo (org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeDetailedPartitionInfo (org.apache.spark.sql.SparkSession spark, org.apache.spark.sql.catalyst.catalog.SessionCatalog catalog, org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> result)  { throw new RuntimeException(); }
  private  void describeExtendedDetailedPartitionInfo (org.apache.spark.sql.catalyst.TableIdentifier tableIdentifier, org.apache.spark.sql.catalyst.catalog.CatalogTable table, org.apache.spark.sql.catalyst.catalog.CatalogTablePartition partition, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeFormattedDetailedPartitionInfo (org.apache.spark.sql.catalyst.TableIdentifier tableIdentifier, org.apache.spark.sql.catalyst.catalog.CatalogTable table, org.apache.spark.sql.catalyst.catalog.CatalogTablePartition partition, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void describeSchema (org.apache.spark.sql.types.StructType schema, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
  private  void append (scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer, java.lang.String column, java.lang.String dataType, java.lang.String comment)  { throw new RuntimeException(); }
}

...
public  class JdbcUtils {
   ...
   * @return (undocumented)
   */
  static public  boolean tableExists (java.sql.Connection conn, org.apache.spark.sql.execution.datasources.jdbc.JDBCOptions options)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.lang.String schemaString (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, java.lang.String url, scala.Option<java.lang.String> createTableColumnTypes)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  scala.collection.immutable.Map<java.lang.String, java.lang.String> parseUserSpecifiedCreateTableColumnTypes (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, java.lang.String createTableColumnTypes)  { throw new RuntimeException(); }
  /**
   ...
   * @param options (undocumented)
   */
  static public  void saveTable (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, scala.Option<org.apache.spark.sql.types.StructType> tableSchema, boolean isCaseSensitive, org.apache.spark.sql.execution.datasources.jdbc.JDBCOptions options)  { throw new RuntimeException(); }
  /**
   ...
   * @param options (undocumented)
   */
  static public  void createTable (java.sql.Connection conn, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, org.apache.spark.sql.execution.datasources.jdbc.JDBCOptions options)  { throw new RuntimeException(); }

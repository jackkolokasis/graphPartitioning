 ...
 * param:  listenerManager Interface to register custom {@link QueryExecutionListener}s.
 ...
 */
  ...
  // not preceding
  public   SessionState (org.apache.spark.sql.internal.SharedState sharedState, org.apache.spark.sql.internal.SQLConf conf, org.apache.spark.sql.ExperimentalMethods experimentalMethods, org.apache.spark.sql.catalyst.analysis.FunctionRegistry functionRegistry, org.apache.spark.sql.UDFRegistration udfRegistration, org.apache.spark.sql.catalyst.catalog.SessionCatalog catalog, org.apache.spark.sql.catalyst.parser.ParserInterface sqlParser, org.apache.spark.sql.catalyst.analysis.Analyzer analyzer, org.apache.spark.sql.catalyst.optimizer.Optimizer optimizer, org.apache.spark.sql.execution.SparkPlanner planner, org.apache.spark.sql.streaming.StreamingQueryManager streamingQueryManager, org.apache.spark.sql.util.ExecutionListenerManager listenerManager, org.apache.spark.sql.internal.SessionResourceLoader resourceLoader, scala.Function1<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan, org.apache.spark.sql.execution.QueryExecution> createQueryExecution, scala.Function2<org.apache.spark.sql.SparkSession, org.apache.spark.sql.internal.SessionState, org.apache.spark.sql.internal.SessionState> createClone)  { throw new RuntimeException(); }

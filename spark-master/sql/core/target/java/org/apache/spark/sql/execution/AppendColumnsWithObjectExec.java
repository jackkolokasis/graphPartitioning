...
public  class AppendColumnsWithObjectExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.ObjectConsumerExec, scala.Product, scala.Serializable {
  ...
  static public  org.apache.spark.sql.types.DataType inputObjectType ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.types.StructType inputSchema ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.types.StructType newColumnSchema ()  { throw new RuntimeException(); }

 ...
 * </code></pre>
 */
public  class CreateDataSourceTableAsSelectCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateDataSourceTableAsSelectCommand (org.apache.spark.sql.catalyst.catalog.CatalogTable table, org.apache.spark.sql.SaveMode mode, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.sources.BaseRelation saveDataIntoTable (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.catalyst.catalog.CatalogTable table, scala.Option<java.net.URI> tableLocation, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan data, org.apache.spark.sql.SaveMode mode, boolean tableExists)  { throw new RuntimeException(); }
}

...
public  class SparkSession implements scala.Serializable, java.io.Closeable, org.apache.spark.internal.Logging {
  ...
  static private  java.lang.String HIVE_SESSION_STATE_BUILDER_CLASS_NAME ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  static private  org.apache.spark.sql.internal.SessionState instantiateSessionState (java.lang.String className, org.apache.spark.sql.SparkSession sparkSession)  { throw new RuntimeException(); }
  /**
  ...
  // not preceding
  private   SparkSession (org.apache.spark.SparkContext sparkContext, scala.Option<org.apache.spark.sql.internal.SharedState> existingSharedState, scala.Option<org.apache.spark.sql.internal.SessionState> parentSessionState)  { throw new RuntimeException(); }
   ...
   * If <code>parentSessionState</code> is not null, the <code>SessionState</code> will be a copy of the parent.
   * <p>
   * This is internal to Spark and there is no guarantee on interface stability.
   * <p>
   * @since 2.2.0

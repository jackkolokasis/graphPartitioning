 ...
 */
public  class CreateViewCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.execution.command.ViewType viewType ()  { throw new RuntimeException(); }
  // not preceding
  public   CreateViewCommand (org.apache.spark.sql.catalyst.TableIdentifier name, scala.collection.Seq<scala.Tuple2<java.lang.String, scala.Option<java.lang.String>>> userSpecifiedColumns, scala.Option<java.lang.String> comment, scala.collection.immutable.Map<java.lang.String, java.lang.String> properties, scala.Option<java.lang.String> originalText, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child, boolean allowExisting, boolean replace, org.apache.spark.sql.execution.command.ViewType viewType)  { throw new RuntimeException(); }
  protected  scala.collection.Seq<org.apache.spark.sql.catalyst.plans.QueryPlan<?>> innerChildren ()  { throw new RuntimeException(); }
  private  boolean isTemporary ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.Row> run (org.apache.spark.sql.SparkSession sparkSession)  { throw new RuntimeException(); }
  /**
   * Permanent views are not allowed to reference temp objects, including temp function and views
   * @param sparkSession (undocumented)
   */
  private  void verifyTemporaryObjectsNotExists (org.apache.spark.sql.SparkSession sparkSession)  { throw new RuntimeException(); }
  /**
   * If <code>userSpecifiedColumns</code> is defined, alias the analyzed plan to the user specified columns,
   * else return the analyzed plan directly.
   * @param session (undocumented)
   * @param analyzedPlan (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan aliasPlan (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan)  { throw new RuntimeException(); }
  /**
   * Returns a {@link CatalogTable} that can be used to save in the catalog. Generate the view-specific
   * properties(e.g. view default database, view query output column names) and store them as
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.catalog.CatalogTable prepareTable (org.apache.spark.sql.SparkSession session, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan)  { throw new RuntimeException(); }
}

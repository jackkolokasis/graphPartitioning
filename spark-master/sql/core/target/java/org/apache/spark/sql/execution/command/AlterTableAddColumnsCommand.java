 ...
 * </code></pre>
 */
public  class AlterTableAddColumnsCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AlterTableAddColumnsCommand (org.apache.spark.sql.catalyst.TableIdentifier table, scala.collection.Seq<org.apache.spark.sql.types.StructField> columns)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.catalog.CatalogTable verifyAlterTableAddColumn (org.apache.spark.sql.catalyst.catalog.SessionCatalog catalog, org.apache.spark.sql.catalyst.TableIdentifier table)  { throw new RuntimeException(); }
}

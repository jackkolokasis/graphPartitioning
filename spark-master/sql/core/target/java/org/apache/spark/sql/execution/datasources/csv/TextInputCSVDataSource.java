...
public  class TextInputCSVDataSource {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.types.StructType inferFromDataset (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.Dataset<java.lang.String> csv, scala.Option<java.lang.String> maybeFirstLine, org.apache.spark.sql.execution.datasources.csv.CSVOptions parsedOptions)  { throw new RuntimeException(); }
  static private  org.apache.spark.sql.Dataset<java.lang.String> createBaseDataset (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> inputPaths, org.apache.spark.sql.execution.datasources.csv.CSVOptions options)  { throw new RuntimeException(); }

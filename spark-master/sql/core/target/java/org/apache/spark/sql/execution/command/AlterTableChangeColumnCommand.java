 ...
 * </code></pre>
 */
public  class AlterTableChangeColumnCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.types.StructField findColumnByName (org.apache.spark.sql.types.StructType schema, java.lang.String name, scala.Function2<java.lang.String, java.lang.String, java.lang.Object> resolver)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.types.StructField addComment (org.apache.spark.sql.types.StructField column, scala.Option<java.lang.String> comment)  { throw new RuntimeException(); }
  private  boolean columnEqual (org.apache.spark.sql.types.StructField field, org.apache.spark.sql.types.StructField other, scala.Function2<java.lang.String, java.lang.String, java.lang.Object> resolver)  { throw new RuntimeException(); }
}

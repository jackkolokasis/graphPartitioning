 ...
 */
public  class SaveIntoDataSourceCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SaveIntoDataSourceCommand (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, java.lang.String provider, scala.collection.Seq<java.lang.String> partitionColumns, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.SaveMode mode)  { throw new RuntimeException(); }

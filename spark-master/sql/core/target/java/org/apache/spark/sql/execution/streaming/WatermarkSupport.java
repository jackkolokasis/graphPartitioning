...
public  interface WatermarkSupport extends org.apache.spark.sql.execution.UnaryExecNode {
  ...
  public  scala.Option<org.apache.spark.sql.catalyst.expressions.codegen.Predicate> watermarkPredicateForKeys ()  ;
  /** Predicate based on the child output that matches data older than the watermark. */
  public  scala.Option<org.apache.spark.sql.catalyst.expressions.codegen.Predicate> watermarkPredicateForData ()  ;
}

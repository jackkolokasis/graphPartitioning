...
public  class DataFrameReader implements org.apache.spark.internal.Logging {
   ...
   * default. For JSON (one record per file), set the <code>wholeFile</code> option to true.
   * <p>
   ...
   *     the malformed string into a field configured by <code>columnNameOfCorruptRecord</code>. To keep
   *     corrupt records, an user can set a string type field named <code>columnNameOfCorruptRecord</code>
   *     in an user-defined schema. If a schema does not have the field, it drops corrupt records
   *     during parsing. When inferring a schema, it implicitly adds a <code>columnNameOfCorruptRecord</code>
   ...
   * <li><code>wholeFile</code> (default <code>false</code>): parse one record, which may span multiple lines,
   * per file</li>
   * </ul>
   * <p>
   * @since 2.0.0
   ...
   *     of a schema, it sets <code>null</code> for extra fields.</li>
   *     <li><code>DROPMALFORMED</code> : ignores the whole corrupted records.</li>
   *     <li><code>FAILFAST</code> : throws an exception when it meets corrupted records.</li>
   *   </ul>
   * </li>
   ...
   * <code>spark.sql.columnNameOfCorruptRecord</code>): allows renaming the new field having malformed string
   * created by <code>PERMISSIVE</code> mode. This overrides <code>spark.sql.columnNameOfCorruptRecord</code>.</li>
   * <li><code>wholeFile</code> (default <code>false</code>): parse one record, which may span multiple lines.</li>
   * </ul>
   * @since 2.0.0
   * @param paths (undocumented)
   * @return (undocumented)
  ...
  */
   ...
   */
  private  void assertNoSpecifiedSchema (java.lang.String operation)  { throw new RuntimeException(); }
  /**
   ...
   */
  private  void verifyColumnNameOfCorruptRecord (org.apache.spark.sql.types.StructType schema, java.lang.String columnNameOfCorruptRecord)  { throw new RuntimeException(); }

 ...
 * </code></pre>
 */
public  class AlterTableRecoverPartitionsCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  private  org.apache.hadoop.fs.PathFilter getPathFilter (org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  ...
  private  scala.collection.parallel.ForkJoinTaskSupport evalTaskSupport ()  { throw new RuntimeException(); }
  private  scala.collection.GenSeq<scala.Tuple2<scala.collection.immutable.Map<java.lang.String, java.lang.String>, org.apache.hadoop.fs.Path>> scanPartitions (org.apache.spark.sql.SparkSession spark, org.apache.hadoop.fs.FileSystem fs, org.apache.hadoop.fs.PathFilter filter, org.apache.hadoop.fs.Path path, scala.collection.immutable.Map<java.lang.String, java.lang.String> spec, scala.collection.Seq<java.lang.String> partitionNames, int threshold, scala.Function2<java.lang.String, java.lang.String, java.lang.Object> resolver)  { throw new RuntimeException(); }
  private  scala.collection.GenMap<java.lang.String, org.apache.spark.sql.execution.command.PartitionStatistics> gatherPartitionStats (org.apache.spark.sql.SparkSession spark, scala.collection.GenSeq<scala.Tuple2<scala.collection.immutable.Map<java.lang.String, java.lang.String>, org.apache.hadoop.fs.Path>> partitionSpecsAndLocs, org.apache.hadoop.fs.FileSystem fs, org.apache.hadoop.fs.PathFilter pathFilter, int threshold)  { throw new RuntimeException(); }
  private  void addPartitions (org.apache.spark.sql.SparkSession spark, org.apache.spark.sql.catalyst.catalog.CatalogTable table, scala.collection.GenSeq<scala.Tuple2<scala.collection.immutable.Map<java.lang.String, java.lang.String>, org.apache.hadoop.fs.Path>> partitionSpecsAndLocs, scala.collection.GenMap<java.lang.String, org.apache.spark.sql.execution.command.PartitionStatistics> partitionStats)  { throw new RuntimeException(); }
}

...
public abstract class SQLImplicits implements org.apache.spark.sql.LowPrioritySQLImplicits {
  ...
  /**
   * @since 1.6.1
   * @deprecated use {@link newStringSequenceEncoder}
   * @return (undocumented)
   */
  public  org.apache.spark.sql.Encoder<scala.collection.Seq<java.lang.String>> newStringSeqEncoder ()  { throw new RuntimeException(); }
  /**
   * @since 1.6.1
   * @deprecated use {@link newProductSequenceEncoder}
   * @param evidence$1 (undocumented)
   * @return (undocumented)
   */
  public <A extends scala.Product> org.apache.spark.sql.Encoder<scala.collection.Seq<A>> newProductSeqEncoder (scala.reflect.api.TypeTags.TypeTag<A> evidence$1)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newIntSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$2)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newLongSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$3)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newDoubleSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$4)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newFloatSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$5)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newByteSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$6)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newShortSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$7)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.Object>> org.apache.spark.sql.Encoder<T> newBooleanSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$8)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<java.lang.String>> org.apache.spark.sql.Encoder<T> newStringSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$9)  { throw new RuntimeException(); }
  /** @since 2.2.0 */
  public <T extends scala.collection.Seq<scala.Product>> org.apache.spark.sql.Encoder<T> newProductSequenceEncoder (scala.reflect.api.TypeTags.TypeTag<T> evidence$10)  { throw new RuntimeException(); }
  /** @since 1.6.1 */
  ...
  /** @since 1.6.1 */
  public <A extends scala.Product> org.apache.spark.sql.Encoder<java.lang.Object> newProductArrayEncoder (scala.reflect.api.TypeTags.TypeTag<A> evidence$11)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> org.apache.spark.sql.DatasetHolder<T> rddToDatasetHolder (org.apache.spark.rdd.RDD<T> rdd, org.apache.spark.sql.Encoder<T> evidence$12)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> org.apache.spark.sql.DatasetHolder<T> localSeqToDatasetHolder (scala.collection.Seq<T> s, org.apache.spark.sql.Encoder<T> evidence$13)  { throw new RuntimeException(); }
  /**

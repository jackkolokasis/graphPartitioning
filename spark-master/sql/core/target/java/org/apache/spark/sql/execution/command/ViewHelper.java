...
public  class ViewHelper {
   ...
   * @return (undocumented)
   */
  static private  scala.collection.immutable.Map<java.lang.String, java.lang.String> generateViewDefaultDatabase (java.lang.String databaseName)  { throw new RuntimeException(); }
  /**
   * Generate the view query output column names in <code>properties</code>.
   * @param columns (undocumented)
   * @return (undocumented)
   */
  static private  scala.collection.immutable.Map<java.lang.String, java.lang.String> generateQueryColumnNames (scala.collection.Seq<java.lang.String> columns)  { throw new RuntimeException(); }
  /**
   * Remove the view query output column names in <code>properties</code>.
   * @param properties (undocumented)
   * @return (undocumented)
   */
  static private  scala.collection.immutable.Map<java.lang.String, java.lang.String> removeQueryColumnNames (scala.collection.immutable.Map<java.lang.String, java.lang.String> properties)  { throw new RuntimeException(); }
  /**

...
public  class CodecStreams {
  static private  scala.Option<org.apache.hadoop.io.compress.CompressionCodec> getDecompressionCodec (org.apache.hadoop.conf.Configuration config, org.apache.hadoop.fs.Path file)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  static public  java.io.InputStream createInputStreamWithCloseResource (org.apache.hadoop.conf.Configuration config, java.lang.String path)  { throw new RuntimeException(); }
  static private  scala.Option<org.apache.hadoop.io.compress.CompressionCodec> getCompressionCodec (org.apache.hadoop.mapreduce.JobContext context, scala.Option<org.apache.hadoop.fs.Path> file)  { throw new RuntimeException(); }
  /**

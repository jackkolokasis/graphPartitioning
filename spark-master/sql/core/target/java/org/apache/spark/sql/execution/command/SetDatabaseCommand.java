 ...
 * </code></pre>
 */
public  class SetDatabaseCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SetDatabaseCommand (java.lang.String databaseName)  { throw new RuntimeException(); }

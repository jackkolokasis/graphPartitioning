...
public  class DataSource implements org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.catalyst.util.CaseInsensitiveMap<java.lang.String> caseInsensitiveOptions ()  { throw new RuntimeException(); }
  /**
   ...
   *         columns.
   */
  private  scala.Tuple2<org.apache.spark.sql.types.StructType, org.apache.spark.sql.types.StructType> getOrInferFileFormatSchema (org.apache.spark.sql.execution.datasources.FileFormat format, org.apache.spark.sql.execution.datasources.FileStatusCache fileStatusCache)  { throw new RuntimeException(); }
  ...
  /**
   * Writes the given {@link DataFrame} out in this {@link FileFormat}.
   * @param format (undocumented)
   * @param mode (undocumented)
   * @param data (undocumented)
   */
  private  void writeInFileFormat (org.apache.spark.sql.execution.datasources.FileFormat format, org.apache.spark.sql.SaveMode mode, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> data)  { throw new RuntimeException(); }
  /**
   * Writes the given {@link DataFrame} out to this {@link DataSource} and returns a {@link BaseRelation} for
   * the following reading.
   * @param mode (undocumented)
   * @param data (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.sources.BaseRelation writeAndRead (org.apache.spark.sql.SaveMode mode, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> data)  { throw new RuntimeException(); }
  /**
   * Writes the given {@link DataFrame} out to this {@link DataSource}.
   * @param mode (undocumented)
   * @param data (undocumented)
   */
  public  void write (org.apache.spark.sql.SaveMode mode, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> data)  { throw new RuntimeException(); }
}

 ...
 */
public  class ShuffleExchange extends org.apache.spark.sql.execution.exchange.Exchange implements scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.execution.exchange.ShuffleExchange apply (org.apache.spark.sql.catalyst.plans.physical.Partitioning newPartitioning, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
  /**
   ...
   */
  static private  boolean needToCopyObjectsBeforeShuffle (org.apache.spark.Partitioner partitioner, org.apache.spark.serializer.Serializer serializer)  { throw new RuntimeException(); }
  ...
  public  scala.Option<org.apache.spark.sql.execution.exchange.ExchangeCoordinator> coordinator ()  { throw new RuntimeException(); }
  // not preceding
  public   ShuffleExchange (org.apache.spark.sql.catalyst.plans.physical.Partitioning newPartitioning, org.apache.spark.sql.execution.SparkPlan child, scala.Option<org.apache.spark.sql.execution.exchange.ExchangeCoordinator> coordinator)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.execution.ShuffledRowRDD cachedShuffleRDD ()  { throw new RuntimeException(); }

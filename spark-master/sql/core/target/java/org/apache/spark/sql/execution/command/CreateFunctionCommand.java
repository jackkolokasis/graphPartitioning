 ...
 * </code></pre>
 */
public  class CreateFunctionCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateFunctionCommand (scala.Option<java.lang.String> databaseName, java.lang.String functionName, java.lang.String className, scala.collection.Seq<org.apache.spark.sql.catalyst.catalog.FunctionResource> resources, boolean isTemp)  { throw new RuntimeException(); }

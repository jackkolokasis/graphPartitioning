 ...
 * That is, in every batch of the <code>streaming.StreamingQuery</code>,
 ...
 *  - With <code>EventTimeTimeout</code>, the user also has to specify the the the event time watermark in
...
public  interface GroupState<S extends java.lang.Object> extends org.apache.spark.sql.catalyst.plans.logical.LogicalGroupState<S> {
  ...
  /**
   * Update the value of the state. Note that <code>null</code> is not a valid value, and it throws
   * IllegalArgumentException.
   * @param newState (undocumented)
   */
  public  void update (S newState) throws java.lang.IllegalArgumentException ;
   ...
   * @note This can return true only when timeouts are enabled in <code>[map/flatmap]GroupsWithStates</code>.
   * @return (undocumented)
   */
   ...
   * <p>
   * @note ProcessingTimeTimeout must be enabled in <code>[map/flatmap]GroupsWithStates</code>.
   * @param durationMs (undocumented)
   */
  public  void setTimeoutDuration (long durationMs) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException ;
  /**
   ...
   */
  public  void setTimeoutDuration (java.lang.String duration) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException ;
  /**
   ...
   * <p>
   * @note EventTimeTimeout must be enabled in <code>[map/flatmap]GroupsWithStates</code>.
   * @param timestampMs (undocumented)
   */
  public  void setTimeoutTimestamp (long timestampMs) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException ;
  /**
   ...
   */
  public  void setTimeoutTimestamp (long timestampMs, java.lang.String additionalDuration) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException ;
  /**
   ...
   */
  public  void setTimeoutTimestamp (java.sql.Date timestamp) throws java.lang.IllegalStateException, java.lang.UnsupportedOperationException ;
  /**
   ...
   * @param additionalDuration (undocumented)
   */
  public  void setTimeoutTimestamp (java.sql.Date timestamp, java.lang.String additionalDuration) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException ;
}

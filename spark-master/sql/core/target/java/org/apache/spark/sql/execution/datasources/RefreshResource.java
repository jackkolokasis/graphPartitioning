...
public  class RefreshResource extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   RefreshResource (java.lang.String path)  { throw new RuntimeException(); }

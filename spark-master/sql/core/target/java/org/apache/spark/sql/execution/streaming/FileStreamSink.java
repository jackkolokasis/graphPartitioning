...
public  class FileStreamSink implements org.apache.spark.sql.execution.streaming.Sink, org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  static public  boolean hasMetadata (scala.collection.Seq<java.lang.String> path, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }

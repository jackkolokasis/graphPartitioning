 ...
 */
  class HiveTableScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.LeafExecNode, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.catalyst.catalog.CatalogRelation relation ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   HiveTableScanExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> requestedAttributes, org.apache.spark.sql.catalyst.catalog.CatalogRelation relation, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> partitionPruningPred, org.apache.spark.sql.SparkSession sparkSession)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.expressions.Attribute> originalAttributes ()  { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output ()  { throw new RuntimeException(); }
  private  scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> boundPruningPred ()  { throw new RuntimeException(); }
  private  org.apache.hadoop.conf.Configuration hadoopConf ()  { throw new RuntimeException(); }
  private  org.apache.hadoop.hive.ql.metadata.Table hiveQlTable ()  { throw new RuntimeException(); }
  private  org.apache.hadoop.hive.ql.plan.TableDesc tableDesc ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.hive.HadoopTableReader hadoopReader ()  { throw new RuntimeException(); }
  private  Object castFromString (java.lang.String value, org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
  private  void addColumnMetadataToConf (org.apache.hadoop.conf.Configuration hiveConf)  { throw new RuntimeException(); }
  /**

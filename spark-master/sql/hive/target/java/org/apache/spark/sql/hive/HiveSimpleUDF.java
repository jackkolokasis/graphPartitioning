package org.apache.spark.sql.hive;
  class HiveSimpleUDF extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.hive.HiveInspectors, org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
  ...
  private  java.lang.reflect.Method method ()  { throw new RuntimeException(); }
  private  org.apache.hadoop.hive.serde2.objectinspector.ObjectInspector[] arguments ()  { throw new RuntimeException(); }
  private  boolean isUDFDeterministic ()  { throw new RuntimeException(); }
  public  boolean foldable ()  { throw new RuntimeException(); }
  private  org.apache.hadoop.hive.ql.udf.generic.GenericUDFUtils.ConversionHelper conversionHelper ()  { throw new RuntimeException(); }

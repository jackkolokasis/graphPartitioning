...
public  class Canonicalize$ {
  ...
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> gatherCommutative (org.apache.spark.sql.catalyst.expressions.Expression e, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>> f)  { throw new RuntimeException(); }
  /** Orders a set of commutative operations by their hash code. */
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> orderCommutative (org.apache.spark.sql.catalyst.expressions.Expression e, scala.PartialFunction<org.apache.spark.sql.catalyst.expressions.Expression, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>> f)  { throw new RuntimeException(); }
  /** Rearrange expressions that are commutative or associative. */
  private  org.apache.spark.sql.catalyst.expressions.Expression expressionReorder (org.apache.spark.sql.catalyst.expressions.Expression e)  { throw new RuntimeException(); }
}

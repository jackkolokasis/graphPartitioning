 ...
 */
public  class MonthsBetween extends org.apache.spark.sql.catalyst.expressions.BinaryExpression implements org.apache.spark.sql.catalyst.expressions.TimeZoneAwareExpression, org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   MonthsBetween (org.apache.spark.sql.catalyst.expressions.Expression date1, org.apache.spark.sql.catalyst.expressions.Expression date2, scala.Option<java.lang.String> timeZoneId)  { throw new RuntimeException(); }

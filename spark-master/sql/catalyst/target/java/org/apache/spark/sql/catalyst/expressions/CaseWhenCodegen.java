 ...
 */
public  class CaseWhenCodegen extends org.apache.spark.sql.catalyst.expressions.CaseWhenBase implements scala.Serializable, scala.Product {
  ...
  static public  scala.collection.Seq<org.apache.spark.sql.types.DataType> valueTypes ()  { throw new RuntimeException(); }
  static public  boolean valueTypesEqual ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   CaseWhenCodegen (scala.collection.Seq<scala.Tuple2<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression>> branches, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> elseValue)  { throw new RuntimeException(); }

...
public  class Literal extends org.apache.spark.sql.catalyst.expressions.LeafExpression implements scala.Product, scala.Serializable {
   ...
   * @return (undocumented)
   */
  static private  org.apache.spark.sql.types.DataType componentTypeToDataType (java.lang.Class<?> clz)  { throw new RuntimeException(); }
  /**
  ...
  static public  org.apache.spark.sql.catalyst.expressions.Literal fromJSON (org.json4s.JsonAST.JValue json)  { throw new RuntimeException(); }

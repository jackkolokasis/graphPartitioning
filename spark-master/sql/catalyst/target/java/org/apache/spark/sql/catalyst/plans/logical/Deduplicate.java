...
public  class Deduplicate extends org.apache.spark.sql.catalyst.plans.logical.UnaryNode implements scala.Product, scala.Serializable {
  ...
  public  boolean streaming ()  { throw new RuntimeException(); }
  // not preceding
  public   Deduplicate (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> keys, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child, boolean streaming)  { throw new RuntimeException(); }

...
public  class CollectList extends org.apache.spark.sql.catalyst.expressions.aggregate.Collect<scala.collection.mutable.ArrayBuffer<java.lang.Object>> implements scala.Product, scala.Serializable {
  ...
  static public final  void update (org.apache.spark.sql.catalyst.InternalRow buffer, org.apache.spark.sql.catalyst.InternalRow input)  { throw new RuntimeException(); }
  static public final  void merge (org.apache.spark.sql.catalyst.InternalRow buffer, org.apache.spark.sql.catalyst.InternalRow inputBuffer)  { throw new RuntimeException(); }
  static public final  Object eval (org.apache.spark.sql.catalyst.InternalRow buffer)  { throw new RuntimeException(); }
  ...
  static public  T update (T buffer, org.apache.spark.sql.catalyst.InternalRow input)  { throw new RuntimeException(); }
  static public  T merge (T buffer, T other)  { throw new RuntimeException(); }
  static public  Object eval (T buffer)  { throw new RuntimeException(); }
  static public  byte[] serialize (T obj)  { throw new RuntimeException(); }
  static public  T deserialize (byte[] bytes)  { throw new RuntimeException(); }

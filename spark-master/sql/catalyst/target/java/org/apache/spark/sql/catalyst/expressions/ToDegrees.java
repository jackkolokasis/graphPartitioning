...
public  class ToDegrees extends org.apache.spark.sql.catalyst.expressions.UnaryMathExpression implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ToDegrees (org.apache.spark.sql.catalyst.expressions.Expression child)  { throw new RuntimeException(); }

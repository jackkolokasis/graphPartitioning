...
public  class Rank extends org.apache.spark.sql.catalyst.expressions.RankLike implements scala.Product, scala.Serializable {
  ...
  static protected  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> orderAttrs ()  { throw new RuntimeException(); }
  static protected  org.apache.spark.sql.catalyst.expressions.Expression orderEquals ()  { throw new RuntimeException(); }
  static protected  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Literal> orderInit ()  { throw new RuntimeException(); }
  static protected  org.apache.spark.sql.catalyst.expressions.AttributeReference rank ()  { throw new RuntimeException(); }
  ...
  static protected  org.apache.spark.sql.catalyst.expressions.Add increaseRowNumber ()  { throw new RuntimeException(); }
  static protected  org.apache.spark.sql.catalyst.expressions.Expression rankSource ()  { throw new RuntimeException(); }
  static protected  org.apache.spark.sql.catalyst.expressions.If increaseRank ()  { throw new RuntimeException(); }
  ...
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Literal> initialValues ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.expressions.Expression evaluateExpression ()  { throw new RuntimeException(); }

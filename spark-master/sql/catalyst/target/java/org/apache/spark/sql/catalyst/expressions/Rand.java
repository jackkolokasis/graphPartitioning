...
public  class Rand extends org.apache.spark.sql.catalyst.expressions.RDG implements scala.Product, scala.Serializable {
  ...
  static protected  org.apache.spark.util.random.XORShiftRandom rng ()  { throw new RuntimeException(); }
  static protected  void rng_$eq (org.apache.spark.util.random.XORShiftRandom x$1)  { throw new RuntimeException(); }
  static protected  void initializeInternal (int partitionIndex)  { throw new RuntimeException(); }
  static protected  long seed ()  { throw new RuntimeException(); }

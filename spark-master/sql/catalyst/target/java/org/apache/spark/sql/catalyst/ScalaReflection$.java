...
public  class ScalaReflection$ implements org.apache.spark.sql.catalyst.ScalaReflection {
  ...
  private  org.apache.spark.sql.catalyst.expressions.Expression serializerFor (org.apache.spark.sql.catalyst.expressions.Expression inputObject, org.apache.spark.sql.catalyst.ScalaReflection.universe tpe, scala.collection.Seq<java.lang.String> walkedTypePath, scala.collection.immutable.Set<scala.reflect.api.Types.TypeApi> seenTypeSet)  { throw new RuntimeException(); }
  /**

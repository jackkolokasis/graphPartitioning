...
public abstract class QueryPlan<PlanType extends org.apache.spark.sql.catalyst.plans.QueryPlan<PlanType>> extends org.apache.spark.sql.catalyst.trees.TreeNode<PlanType> {
  ...
  /**
   * Returns {@link constraints} depending on the config of enabling constraint propagation. If the
   * flag is disabled, simply returning an empty constraints.
   * @param constraintPropagationEnabled (undocumented)
   * @return (undocumented)
   */
    org.apache.spark.sql.catalyst.expressions.ExpressionSet getConstraints (boolean constraintPropagationEnabled)  { throw new RuntimeException(); }
  /**

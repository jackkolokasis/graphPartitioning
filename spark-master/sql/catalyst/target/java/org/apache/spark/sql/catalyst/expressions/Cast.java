...
public  class Cast extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.TimeZoneAwareExpression, org.apache.spark.sql.catalyst.expressions.NullIntolerant, scala.Product, scala.Serializable {
  /**
   ...
   * @return (undocumented)
   */
  static public  boolean mayTruncate (org.apache.spark.sql.types.DataType from, org.apache.spark.sql.types.DataType to)  { throw new RuntimeException(); }
  ...
  /**
   * Create new <code>Decimal</code> with precision and scale given in <code>decimalType</code> (if any),
   * returning null if it overflows or creating a new <code>value</code> and returning it if successful.
   * <p>
   * @param value (undocumented)
   * @param decimalType (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.types.Decimal toPrecision (org.apache.spark.sql.types.Decimal value, org.apache.spark.sql.types.DecimalType decimalType)  { throw new RuntimeException(); }
  ...
  private  scala.Function3<java.lang.String, java.lang.String, java.lang.String, java.lang.String> castToByteCode (org.apache.spark.sql.types.DataType from, org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  private  scala.Function3<java.lang.String, java.lang.String, java.lang.String, java.lang.String> castToShortCode (org.apache.spark.sql.types.DataType from, org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  private  scala.Function3<java.lang.String, java.lang.String, java.lang.String, java.lang.String> castToIntCode (org.apache.spark.sql.types.DataType from, org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
  private  scala.Function3<java.lang.String, java.lang.String, java.lang.String, java.lang.String> castToLongCode (org.apache.spark.sql.types.DataType from, org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }

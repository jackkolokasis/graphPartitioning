...
public  class DateTimeUtils {
  ...
  static private  java.lang.ThreadLocal<java.text.DateFormat> threadLocalTimestampFormat ()  { throw new RuntimeException(); }
  static public  java.text.DateFormat getThreadLocalTimestampFormat (java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  static private  java.lang.ThreadLocal<java.text.DateFormat> threadLocalDateFormat ()  { throw new RuntimeException(); }
  static public  java.text.DateFormat getThreadLocalDateFormat ()  { throw new RuntimeException(); }
  static public  java.text.DateFormat newDateFormat (java.lang.String formatString, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  ...
  static public  java.lang.String timestampToString (long us, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  ...
  static public  scala.Option<java.lang.Object> stringToTimestamp (org.apache.spark.unsafe.types.UTF8String s, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  /**
  ...
  static private  long localTimestamp (long microsec, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  long timestampAddInterval (long start, int months, long microseconds, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  double monthsBetween (long time1, long time2, java.util.TimeZone timeZone)  { throw new RuntimeException(); }

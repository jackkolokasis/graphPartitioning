...
public  class SortOrder extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.Unevaluable, scala.Product, scala.Serializable {
  ...
  public  scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> sameOrderExpressions ()  { throw new RuntimeException(); }
  // not preceding
  public   SortOrder (org.apache.spark.sql.catalyst.expressions.Expression child, org.apache.spark.sql.catalyst.expressions.SortDirection direction, org.apache.spark.sql.catalyst.expressions.NullOrdering nullOrdering, scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> sameOrderExpressions)  { throw new RuntimeException(); }

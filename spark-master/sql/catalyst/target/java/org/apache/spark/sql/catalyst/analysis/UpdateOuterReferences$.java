...
public  class UpdateOuterReferences$ extends org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> {
  ...
  private  org.apache.spark.sql.catalyst.expressions.Expression stripAlias (org.apache.spark.sql.catalyst.expressions.Expression expr)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan updateOuterReferenceInSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> refExprs)  { throw new RuntimeException(); }

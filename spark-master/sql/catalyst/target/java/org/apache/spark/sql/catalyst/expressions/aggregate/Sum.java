...
public  class Sum extends org.apache.spark.sql.catalyst.expressions.aggregate.DeclarativeAggregate implements org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.types.NumericType resultType ()  { throw new RuntimeException(); }
  private  org.apache.spark.sql.types.NumericType sumDataType ()  { throw new RuntimeException(); }

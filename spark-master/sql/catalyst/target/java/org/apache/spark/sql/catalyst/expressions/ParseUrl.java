...
public  class ParseUrl extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.ExpectsInputTypes, org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, scala.Product, scala.Serializable {
  static private  org.apache.spark.unsafe.types.UTF8String HOST ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String PATH ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String QUERY ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String REF ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String PROTOCOL ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String FILE ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String AUTHORITY ()  { throw new RuntimeException(); }
  static private  org.apache.spark.unsafe.types.UTF8String USERINFO ()  { throw new RuntimeException(); }
  static private  java.lang.String REGEXPREFIX ()  { throw new RuntimeException(); }
  static private  java.lang.String REGEXSUBFIX ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ParseUrl (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> children)  { throw new RuntimeException(); }
  ...
  private  java.net.URI cachedUrl ()  { throw new RuntimeException(); }
  private  java.util.regex.Pattern cachedPattern ()  { throw new RuntimeException(); }
  private  scala.Function1<java.net.URI, java.lang.String> cachedExtractPartFunc ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.analysis.TypeCheckResult checkInputDataTypes ()  { throw new RuntimeException(); }
  private  java.util.regex.Pattern getPattern (org.apache.spark.unsafe.types.UTF8String key)  { throw new RuntimeException(); }
  private  java.net.URI getUrl (org.apache.spark.unsafe.types.UTF8String url)  { throw new RuntimeException(); }
  private  scala.Function1<java.net.URI, java.lang.String> getExtractPartFunc (org.apache.spark.unsafe.types.UTF8String partToExtract)  { throw new RuntimeException(); }
  private  org.apache.spark.unsafe.types.UTF8String extractValueFromQuery (org.apache.spark.unsafe.types.UTF8String query, java.util.regex.Pattern pattern)  { throw new RuntimeException(); }
  private  org.apache.spark.unsafe.types.UTF8String extractFromUrl (java.net.URI url, org.apache.spark.unsafe.types.UTF8String partToExtract)  { throw new RuntimeException(); }
  private  org.apache.spark.unsafe.types.UTF8String parseUrlWithoutKey (org.apache.spark.unsafe.types.UTF8String url, org.apache.spark.unsafe.types.UTF8String partToExtract)  { throw new RuntimeException(); }

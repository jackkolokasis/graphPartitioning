...
public  class PosExplode extends org.apache.spark.sql.catalyst.expressions.ExplodeBase implements scala.Product, scala.Serializable {
  ...
  static public  boolean foldable ()  { throw new RuntimeException(); }
  static public  boolean nullable ()  { throw new RuntimeException(); }
  static public  scala.collection.TraversableOnce<org.apache.spark.sql.catalyst.InternalRow> terminate ()  { throw new RuntimeException(); }
  static public  boolean supportCodegen ()  { throw new RuntimeException(); }
  static public  boolean inline ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.analysis.TypeCheckResult checkInputDataTypes ()  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.StructType elementSchema ()  { throw new RuntimeException(); }
  static public  scala.collection.TraversableOnce<org.apache.spark.sql.catalyst.InternalRow> eval (org.apache.spark.sql.catalyst.InternalRow input)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.DataType collectionType ()  { throw new RuntimeException(); }

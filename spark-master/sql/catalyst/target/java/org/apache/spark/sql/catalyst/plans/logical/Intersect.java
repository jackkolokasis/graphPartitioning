...
public  class Intersect extends org.apache.spark.sql.catalyst.plans.logical.SetOperation implements scala.Product, scala.Serializable {
  ...
  static public  boolean duplicateResolved ()  { throw new RuntimeException(); }
  static protected  scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> leftConstraints ()  { throw new RuntimeException(); }
  static protected  scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> rightConstraints ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   Intersect (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan left, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan right)  { throw new RuntimeException(); }

...
public  class Range extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.catalyst.plans.logical.Range apply (long start, long end, long step, scala.Option<java.lang.Object> numSlices)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   Range (long start, long end, long step, scala.Option<java.lang.Object> numSlices, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output)  { throw new RuntimeException(); }

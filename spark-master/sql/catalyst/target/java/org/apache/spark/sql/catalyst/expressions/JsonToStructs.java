...
/**
 * Converts an json input string to a {@link StructType} or {@link ArrayType} of {@link StructType}s
...
public  class JsonToStructs extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.TimeZoneAwareExpression, org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, org.apache.spark.sql.catalyst.expressions.ExpectsInputTypes, scala.Product, scala.Serializable {
  ...
  public   JsonToStructs (org.apache.spark.sql.types.DataType schema, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.expressions.Expression child)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.types.StructType rowSchema ()  { throw new RuntimeException(); }
  public  scala.Function1<scala.collection.Seq<org.apache.spark.sql.catalyst.InternalRow>, scala.Serializable> converter ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.json.JacksonParser parser ()  { throw new RuntimeException(); }

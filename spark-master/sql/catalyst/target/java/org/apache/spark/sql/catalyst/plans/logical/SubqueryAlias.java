...
public  class SubqueryAlias extends org.apache.spark.sql.catalyst.plans.logical.UnaryNode implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SubqueryAlias (java.lang.String alias, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child)  { throw new RuntimeException(); }

...
public  class Union extends org.apache.spark.sql.catalyst.plans.logical.LogicalPlan implements scala.Product, scala.Serializable {
   ...
   * @param reference (undocumented)
   * @param original (undocumented)
   * @param constraints (undocumented)
   * @return (undocumented)
   */
  private  scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> rewriteConstraints (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> reference, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> original, scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> constraints)  { throw new RuntimeException(); }
  private  scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> merge (scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> a, scala.collection.immutable.Set<org.apache.spark.sql.catalyst.expressions.Expression> b)  { throw new RuntimeException(); }

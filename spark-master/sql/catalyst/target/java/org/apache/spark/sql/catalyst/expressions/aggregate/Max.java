...
public  class Max extends org.apache.spark.sql.catalyst.expressions.aggregate.DeclarativeAggregate implements scala.Product, scala.Serializable {
  ...
  private  org.apache.spark.sql.catalyst.expressions.AttributeReference max ()  { throw new RuntimeException(); }

...
public  class Word2Vec implements scala.Serializable, org.apache.spark.internal.Logging {
  ...
  private <S extends scala.collection.Iterable<java.lang.String>> org.apache.spark.mllib.feature.Word2VecModel doFit (org.apache.spark.rdd.RDD<S> dataset, org.apache.spark.SparkContext sc, org.apache.spark.broadcast.Broadcast<float[]> expTable, org.apache.spark.broadcast.Broadcast<org.apache.spark.mllib.feature.VocabWord[]> bcVocab, org.apache.spark.broadcast.Broadcast<scala.collection.mutable.HashMap<java.lang.String, java.lang.Object>> bcVocabHash)  { throw new RuntimeException(); }
  /**

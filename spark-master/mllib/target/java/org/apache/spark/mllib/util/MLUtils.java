...
public  class MLUtils {
   ...
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertVectorColumnsToML (org.apache.spark.sql.Dataset<?> dataset, java.lang.String... cols)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertVectorColumnsFromML (org.apache.spark.sql.Dataset<?> dataset, java.lang.String... cols)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertMatrixColumnsToML (org.apache.spark.sql.Dataset<?> dataset, java.lang.String... cols)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertMatrixColumnsFromML (org.apache.spark.sql.Dataset<?> dataset, java.lang.String... cols)  { throw new RuntimeException(); }
  ...
  static   int computeNumFeatures (org.apache.spark.rdd.RDD<scala.Tuple3<java.lang.Object, int[], double[]>> rdd)  { throw new RuntimeException(); }
  static   org.apache.spark.rdd.RDD<scala.Tuple3<java.lang.Object, int[], double[]>> parseLibSVMFile (org.apache.spark.SparkContext sc, java.lang.String path, int minPartitions)  { throw new RuntimeException(); }
  static   scala.Tuple3<java.lang.Object, int[], double[]> parseLibSVMRecord (java.lang.String line)  { throw new RuntimeException(); }
  /**
   ...
   * @see <code>org.apache.spark.mllib.util.MLUtils.loadLibSVMFile</code>
   */
   ...
   * @return (undocumented)
   */
  static public <T extends java.lang.Object> scala.Tuple2<org.apache.spark.rdd.RDD<T>, org.apache.spark.rdd.RDD<T>>[] kFold (org.apache.spark.rdd.RDD<T> rdd, int numFolds, long seed, scala.reflect.ClassTag<T> evidence$2)  { throw new RuntimeException(); }
  /**
   ...
   * @return the input <code>DataFrame</code> with old vector columns converted to the new vector type
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertVectorColumnsToML (org.apache.spark.sql.Dataset<?> dataset, scala.collection.Seq<java.lang.String> cols)  { throw new RuntimeException(); }
  /**
   * Converts vector columns in an input Dataset to the {@link org.apache.spark.mllib.linalg.Vector}
   * type from the new {@link org.apache.spark.ml.linalg.Vector} type under the <code>spark.ml</code> package.
   * @param dataset input dataset
   ...
   * @return the input <code>DataFrame</code> with new vector columns converted to the old vector type
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertVectorColumnsFromML (org.apache.spark.sql.Dataset<?> dataset, scala.collection.Seq<java.lang.String> cols)  { throw new RuntimeException(); }
  /**
   * Converts Matrix columns in an input Dataset from the {@link org.apache.spark.mllib.linalg.Matrix}
   * type to the new {@link org.apache.spark.ml.linalg.Matrix} type under the <code>spark.ml</code> package.
   * @param dataset input dataset
   ...
   * @return the input <code>DataFrame</code> with old matrix columns converted to the new matrix type
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertMatrixColumnsToML (org.apache.spark.sql.Dataset<?> dataset, scala.collection.Seq<java.lang.String> cols)  { throw new RuntimeException(); }
  /**
   * Converts matrix columns in an input Dataset to the {@link org.apache.spark.mllib.linalg.Matrix}
   * type from the new {@link org.apache.spark.ml.linalg.Matrix} type under the <code>spark.ml</code> package.
   * @param dataset input dataset
   ...
   * @return the input <code>DataFrame</code> with new matrix columns converted to the old matrix type
   */
  static public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> convertMatrixColumnsFromML (org.apache.spark.sql.Dataset<?> dataset, scala.collection.Seq<java.lang.String> cols)  { throw new RuntimeException(); }
  /**
   ...
   */
  static   double fastSquaredDistance (org.apache.spark.mllib.linalg.Vector v1, double norm1, org.apache.spark.mllib.linalg.Vector v2, double norm2, double precision)  { throw new RuntimeException(); }
  /**
   ...
   */
  static   double log1pExp (double x)  { throw new RuntimeException(); }

...
public  class GBTClassificationModel extends org.apache.spark.ml.classification.ProbabilisticClassificationModel<org.apache.spark.ml.linalg.Vector, org.apache.spark.ml.classification.GBTClassificationModel> implements org.apache.spark.ml.tree.GBTClassifierParams, org.apache.spark.ml.tree.TreeEnsembleModel<org.apache.spark.ml.regression.DecisionTreeRegressionModel>, org.apache.spark.ml.util.MLWritable, scala.Serializable {
  ...
  static private  class GBTClassificationModelReader extends org.apache.spark.ml.util.MLReader<org.apache.spark.ml.classification.GBTClassificationModel> {
    public   GBTClassificationModelReader ()  { throw new RuntimeException(); }
  ...
  static private  java.lang.String numFeaturesKey ()  { throw new RuntimeException(); }
  static private  java.lang.String numTreesKey ()  { throw new RuntimeException(); }
  ...
  static   org.apache.spark.mllib.tree.loss.ClassificationLoss getOldLossType ()  { throw new RuntimeException(); }
  ...
  private  double margin (org.apache.spark.ml.linalg.Vector features)  { throw new RuntimeException(); }
  /** (private[ml]) Convert to a model in the old API */
    org.apache.spark.mllib.tree.model.GradientBoostedTreesModel toOld ()  { throw new RuntimeException(); }
  private  org.apache.spark.mllib.tree.loss.ClassificationLoss loss ()  { throw new RuntimeException(); }

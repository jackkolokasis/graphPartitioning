...
public  class MinHashLSHModel extends org.apache.spark.ml.feature.LSHModel<org.apache.spark.ml.feature.MinHashLSHModel> {
  static   class MinHashLSHModelWriter extends org.apache.spark.ml.util.MLWriter {
    ...
    private  class Data implements scala.Product, scala.Serializable {
      public  int[] randCoefficients ()  { throw new RuntimeException(); }
      // not preceding
      public   Data (int[] randCoefficients)  { throw new RuntimeException(); }
    }
    private  class Data extends scala.runtime.AbstractFunction1<int[], org.apache.spark.ml.feature.MinHashLSHModel.MinHashLSHModelWriter.Data> implements scala.Serializable {
      public   Data ()  { throw new RuntimeException(); }
    }
    protected  void saveImpl (java.lang.String path)  { throw new RuntimeException(); }
  }
  static private  class MinHashLSHModelReader extends org.apache.spark.ml.util.MLReader<org.apache.spark.ml.feature.MinHashLSHModel> {
    public   MinHashLSHModelReader ()  { throw new RuntimeException(); }
    /** Checked against metadata when loading model */
    private  java.lang.String className ()  { throw new RuntimeException(); }
    public  org.apache.spark.ml.feature.MinHashLSHModel load (java.lang.String path)  { throw new RuntimeException(); }
  }

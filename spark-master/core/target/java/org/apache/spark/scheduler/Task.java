 ...
 */
 abstract class Task<T extends java.lang.Object> implements scala.Serializable {
  ...
  // not preceding
  public   Task (int stageId, int stageAttemptId, int partitionId, java.util.Properties localProperties, byte[] serializedTaskMetrics, scala.Option<java.lang.Object> jobId, scala.Option<java.lang.String> appId, scala.Option<java.lang.String> appAttemptId)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.TaskContextImpl context ()  { throw new RuntimeException(); }
  private  java.lang.Thread taskThread ()  { throw new RuntimeException(); }
  private  java.lang.String _reasonIfKilled ()  { throw new RuntimeException(); }

 ...
 */
 abstract class Stage implements org.apache.spark.internal.Logging {
  ...
  /**
   * Pointer to the {@link StageInfo} object for the most recent attempt. This needs to be initialized
   ...
   * @return (undocumented)
   */
  public  scala.collection.mutable.HashSet<java.lang.Object> fetchFailedAttemptIds ()  { throw new RuntimeException(); }

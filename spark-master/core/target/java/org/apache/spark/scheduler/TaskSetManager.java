 ...
 */
  ...
  static public abstract  void parent_$eq (org.apache.spark.scheduler.Pool x$1)  ;
  ...
  // not preceding
  public   TaskSetManager (org.apache.spark.scheduler.TaskSchedulerImpl sched, org.apache.spark.scheduler.TaskSet taskSet, int maxTaskFailures, scala.Option<org.apache.spark.scheduler.BlacklistTracker> blacklistTracker, org.apache.spark.util.Clock clock)  { throw new RuntimeException(); }
  ...
  private  long totalResultSize ()  { throw new RuntimeException(); }
  private  int calculatedTasks ()  { throw new RuntimeException(); }
    scala.Option<org.apache.spark.scheduler.TaskSetBlacklist> taskSetBlacklistHelperOpt ()  { throw new RuntimeException(); }
  ...
  private  scala.collection.mutable.HashMap<java.lang.String, scala.collection.mutable.ArrayBuffer<java.lang.Object>> pendingTasksForRack ()  { throw new RuntimeException(); }
    scala.collection.mutable.ArrayBuffer<java.lang.Object> pendingTasksWithNoPrefs ()  { throw new RuntimeException(); }
  private  scala.collection.mutable.ArrayBuffer<java.lang.Object> allPendingTasks ()  { throw new RuntimeException(); }
    scala.collection.mutable.HashSet<java.lang.Object> speculatableTasks ()  { throw new RuntimeException(); }
  private  scala.collection.mutable.HashMap<java.lang.Object, org.apache.spark.scheduler.TaskInfo> taskInfos ()  { throw new RuntimeException(); }
  ...
  private  scala.collection.mutable.HashMap<java.lang.String, scala.Tuple2<java.lang.Object, java.lang.Object>> recentExceptions ()  { throw new RuntimeException(); }
  ...
  private  int currentLocalityIndex ()  { throw new RuntimeException(); }
  private  long lastLaunchTime ()  { throw new RuntimeException(); }
  ...
  private  void addPendingTask (int index)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.Option<java.lang.Object> dequeueTaskFromList (java.lang.String execId, java.lang.String host, scala.collection.mutable.ArrayBuffer<java.lang.Object> list)  { throw new RuntimeException(); }
  /** Check whether a task is currently running an attempt on a given host */
  private  boolean hasAttemptOnHost (int taskIndex, java.lang.String host)  { throw new RuntimeException(); }
  private  boolean isTaskBlacklistedOnExecOrNode (int index, java.lang.String execId, java.lang.String host)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  protected  scala.Option<scala.Tuple2<java.lang.Object, scala.Enumeration.Value>> dequeueSpeculativeTask (java.lang.String execId, java.lang.String host, scala.Enumeration.Value locality)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.scheduler.TaskDescription> resourceOffer (java.lang.String execId, java.lang.String host, scala.Enumeration.Value maxLocality) throws org.apache.spark.TaskNotSerializableException { throw new RuntimeException(); }
  private  void maybeFinishTaskSet ()  { throw new RuntimeException(); }
  /**
   * Get the level we can launch tasks according to delay scheduling, based on current wait time.
   * @param curTime (undocumented)
   * @return (undocumented)
   */
   ...
   */
    void abortIfCompletelyBlacklisted (scala.collection.mutable.HashMap<java.lang.String, scala.collection.mutable.HashSet<java.lang.String>> hostToExecutors)  { throw new RuntimeException(); }
  /**

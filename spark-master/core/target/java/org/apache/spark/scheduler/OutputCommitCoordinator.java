 ...
 */
  ...
  private  class StageState implements scala.Product, scala.Serializable {
    ...
    public  int[] authorizedCommitters ()  { throw new RuntimeException(); }
    public  scala.collection.mutable.Map<java.lang.Object, scala.collection.mutable.Set<java.lang.Object>> failures ()  { throw new RuntimeException(); }
  }
  ...
  private  boolean attemptFailed (org.apache.spark.scheduler.OutputCommitCoordinator.StageState stageState, int partition, int attempt)  { throw new RuntimeException(); }
}

 ...
 */
  ...
  static public  org.apache.spark.TaskContextImpl context ()  { throw new RuntimeException(); }
  static public  void context_$eq (org.apache.spark.TaskContextImpl x$1)  { throw new RuntimeException(); }
  ...
  static public  scala.Option<java.lang.String> reasonIfKilled ()  { throw new RuntimeException(); }
  ...
  static public  void kill (boolean interruptThread, java.lang.String reason)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ResultTask (int stageId, int stageAttemptId, org.apache.spark.broadcast.Broadcast<byte[]> taskBinary, org.apache.spark.Partition partition, scala.collection.Seq<org.apache.spark.scheduler.TaskLocation> locs, int outputId, java.util.Properties localProperties, byte[] serializedTaskMetrics, scala.Option<java.lang.Object> jobId, scala.Option<java.lang.String> appId, scala.Option<java.lang.String> appAttemptId)  { throw new RuntimeException(); }

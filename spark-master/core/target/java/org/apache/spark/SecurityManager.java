 ...
 * <p>
 * Spark has a set of individual and group modify acls (<code>spark.modify.acls</code>) and
 * (<code>spark.modify.acls.groups</code>) that controls which users and groups have permission to
 ...
 * <p>
 * Spark also has a set of individual and group admin acls (<code>spark.admin.acls</code>) and
 * (<code>spark.admin.acls.groups</code>) which is a set of users/administrators and admin groups
 ...
 *  individually.
 * <p>
 *  All the SSL settings like <code>spark.ssl.xxx</code> where <code>xxx</code> is a particular configuration property,
 ...
 *  protocol-specific namespace. Use <code>spark.ssl.yyy.xxx</code> settings to overwrite the global
 *  configuration for particular protocol denoted by <code>yyy</code>. Currently <code>yyy</code> can be only<code>fs</code> for
 *  broadcast and file server.
 * <p>
 *  Refer to {@link org.apache.spark.SSLOptions} documentation for the list of
 ...
 *  setting <code>spark.ssl.useNodeLocalConf</code> to <code>true</code>.
 */
  ...
  static public  java.lang.String SECRET_LOOKUP_KEY ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.SSLOptions fileServerSSLOptions ()  { throw new RuntimeException(); }
  public  scala.Option<javax.net.ssl.SSLSocketFactory> sslSocketFactory ()  { throw new RuntimeException(); }
  public  scala.Option<java.lang.Object> hostnameVerifier ()  { throw new RuntimeException(); }

...
public  class UIUtils {
  ...
  static public  scala.collection.Seq<scala.xml.Node> dataTablesHeaderNodes ()  { throw new RuntimeException(); }
  ...
  static public  scala.collection.Seq<scala.xml.Node> basicSparkPage (scala.Function0<scala.collection.Seq<scala.xml.Node>> content, java.lang.String title, boolean useDataTables)  { throw new RuntimeException(); }

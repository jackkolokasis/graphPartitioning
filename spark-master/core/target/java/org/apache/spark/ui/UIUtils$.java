...
public  class UIUtils$ implements org.apache.spark.internal.Logging {
  ...
  public  scala.collection.Seq<scala.xml.Node> makeProgressBar (int started, int completed, int failed, int skipped, scala.collection.immutable.Map<java.lang.String, java.lang.Object> reasonToNumKilled, int total)  { throw new RuntimeException(); }

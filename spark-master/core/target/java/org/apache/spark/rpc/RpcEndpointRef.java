 ...
 */
 abstract class RpcEndpointRef implements scala.Serializable, org.apache.spark.internal.Logging {
   ...
   */
  public <T extends java.lang.Object> T askSync (Object message, scala.reflect.ClassTag<T> evidence$3)  { throw new RuntimeException(); }
  /**
   * Send a message to the corresponding {@link RpcEndpoint.receiveAndReply} and get its result within a
   ...
   */
  public <T extends java.lang.Object> T askSync (Object message, org.apache.spark.rpc.RpcTimeout timeout, scala.reflect.ClassTag<T> evidence$4)  { throw new RuntimeException(); }
}

...
public  class EncryptedBlockData implements org.apache.spark.storage.BlockData {
  ...
  private  java.nio.channels.ReadableByteChannel open ()  { throw new RuntimeException(); }
}

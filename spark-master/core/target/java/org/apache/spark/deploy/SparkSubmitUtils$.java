...
public  class SparkSubmitUtils$ {
  ...
  private  void processIvyPathArg (org.apache.ivy.core.settings.IvySettings ivySettings, scala.Option<java.lang.String> ivyPath)  { throw new RuntimeException(); }
  private  void processRemoteRepoArg (org.apache.ivy.core.settings.IvySettings ivySettings, scala.Option<java.lang.String> remoteRepos)  { throw new RuntimeException(); }
   ...
   */
  public  java.lang.String resolveMavenCoordinates (java.lang.String coordinates, org.apache.ivy.core.settings.IvySettings ivySettings, scala.collection.Seq<java.lang.String> exclusions, boolean isTest)  { throw new RuntimeException(); }

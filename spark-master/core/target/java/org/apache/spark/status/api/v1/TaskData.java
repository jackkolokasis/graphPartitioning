...
public  class TaskData {
  ...
  // not preceding
     TaskData (long taskId, int index, int attempt, java.util.Date launchTime, scala.Option<java.lang.Object> duration, java.lang.String executorId, java.lang.String host, java.lang.String status, java.lang.String taskLocality, boolean speculative, scala.collection.Seq<org.apache.spark.status.api.v1.AccumulableInfo> accumulatorUpdates, scala.Option<java.lang.String> errorMessage, scala.Option<org.apache.spark.status.api.v1.TaskMetrics> taskMetrics)  { throw new RuntimeException(); }
}
